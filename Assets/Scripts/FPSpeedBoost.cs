...
public class FPSpeedBoost : MonoBehaviour
{
    private FPController _playerMoveScript;
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            _playerMoveScript = other.GetComponent<FPController>(); // Get a reference to the script PlayerMove
